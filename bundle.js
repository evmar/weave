...
(() => {
  ...
  var require_tree = __commonJS({
    "../node_modules/webtreemap/build/tree.js"(exports) {
      ...
      function sort(n2) {
        ...
        n2.children.sort(function(a3, b2) {
      ...
      var TreeMap = (function() {
        ...
        TreeMap2.prototype.layoutChildren = function(node, level, width, height) {
          ...
          if (this.options.showChildren(node, x22 - x1, y22 - y1)) {
            ...
            var x3 = x1, y3 = y1;
            children: for (var start2 = 0; start2 < children2.length; ) {
              x3 = x1;
  ...
  function readFuncType(r3) {
    if (r3.read8() !== 96) throw new Error(`expected function type`);
    const params = r3.vec(() => readValType(r3));
    const result = r3.vec(() => readValType(r3));
    return { params, result };
  }
  function funcTypeToString(f4) {
    const params = f4.params.join(", ");
    if (f4.result.length == 0) {
      return `(${params})`;
    }
    const result = f4.result.join(", ");
    return `(${params}) => ${result}`;
  }
  ...
  function readMemArg(r3) {
    let align = r3.readUint();
    let index = 0;
    if (align & 64) {
      index = r3.readUint();
      align = align & ~64;
  ...
  function readInstruction(r3) {
    ...
    switch (op) {
      ...
      case 37:
        return { op: "table.get" /* table_get */, index: r3.readUint() };
      case 38:
        return { op: "table.set" /* table_set */, index: r3.readUint() };
      case 40:
        return { op: "i32.load" /* i32_load */, memarg: readMemArg(r3) };
      case 41:
        return { op: "i64.load" /* i64_load */, memarg: readMemArg(r3) };
      case 42:
        return { op: "f32.load" /* f32_load */, memarg: readMemArg(r3) };
      case 43:
        return { op: "f64.load" /* f64_load */, memarg: readMemArg(r3) };
      case 44:
        return { op: "i32.load8_s" /* i32_load8_s */, memarg: readMemArg(r3) };
      case 45:
        return { op: "i32.load8_u" /* i32_load8_u */, memarg: readMemArg(r3) };
      case 46:
        return { op: "i32.load16_s" /* i32_load16_s */, memarg: readMemArg(r3) };
      case 47:
        return { op: "i32.load16_u" /* i32_load16_u */, memarg: readMemArg(r3) };
      case 48:
        return { op: "i64.load8_s" /* i64_load8_s */, memarg: readMemArg(r3) };
      case 49:
        return { op: "i64.load8_u" /* i64_load8_u */, memarg: readMemArg(r3) };
      case 50:
        return { op: "i64.load16_s" /* i64_load16_s */, memarg: readMemArg(r3) };
      case 51:
        return { op: "i64.load16_u" /* i64_load16_u */, memarg: readMemArg(r3) };
      case 52:
        return { op: "i64.load32_s" /* i64_load32_s */, memarg: readMemArg(r3) };
      case 53:
        return { op: "i64.load32_u" /* i64_load32_u */, memarg: readMemArg(r3) };
      case 54:
        return { op: "i32.store" /* i32_store */, memarg: readMemArg(r3) };
      case 55:
        return { op: "i64.store" /* i64_store */, memarg: readMemArg(r3) };
      case 56:
        return { op: "f32.store" /* f32_store */, memarg: readMemArg(r3) };
      case 57:
        return { op: "f64.store" /* f64_store */, memarg: readMemArg(r3) };
      case 58:
        return { op: "i32.store8" /* i32_store8 */, memarg: readMemArg(r3) };
      case 59:
        return { op: "i32.store16" /* i32_store16 */, memarg: readMemArg(r3) };
      case 60:
        return { op: "i64.store8" /* i64_store8 */, memarg: readMemArg(r3) };
      case 61:
        return { op: "i64.store16" /* i64_store16 */, memarg: readMemArg(r3) };
      case 62:
        return { op: "i64.store32" /* i64_store32 */, memarg: readMemArg(r3) };
      case 63:
        return { op: "memory.size" /* memory_size */, mem: r3.readUint() };
      case 64:
        return { op: "memory.grow" /* memory_grow */, mem: r3.readUint() };
      case 65:
      ...
      case 252: {
        const op2 = r3.readUint();
        switch (op2) {
          case 0:
            return { op: "i32.trunc_sat_s_f32" /* i32_trunc_sat_s_f32 */ };
          case 1:
            return { op: "i32.trunc_sat_u_f32" /* i32_trunc_sat_u_f32 */ };
          case 2:
            return { op: "i32.trunc_sat_s_f64" /* i32_trunc_sat_s_f64 */ };
          case 3:
            return { op: "i32.trunc_sat_u_f64" /* i32_trunc_sat_u_f64 */ };
          case 4:
            return { op: "i64.trunc_sat_s_f32" /* i64_trunc_sat_s_f32 */ };
          case 5:
            return { op: "i64.trunc_sat_u_f32" /* i64_trunc_sat_u_f32 */ };
          case 6:
            return { op: "i64.trunc_sat_s_f64" /* i64_trunc_sat_s_f64 */ };
          case 7:
            return { op: "i64.trunc_sat_u_f64" /* i64_trunc_sat_u_f64 */ };
          case 8:
            return { op: "memory.init" /* memory_init */, data: r3.readUint(), mem: r3.readUint() };
          case 9:
            return { op: "data.drop" /* data_drop */, data: r3.readUint() };
          case 10:
            return { op: "memory.copy" /* memory_copy */, dstMem: r3.readUint(), srcMem: r3.readUint() };
          case 11:
            return { op: "memory.fill" /* memory_fill */, mem: r3.readUint() };
          case 15:
            return { op: "table.grow" /* table_grow */, index: r3.readUint() };
          case 16:
            return { op: "table.size" /* table_size */, index: r3.readUint() };
          case 17:
            return { op: "table.fill" /* table_fill */, index: r3.readUint() };
          default:
            throw new Error(`unhandled op fc ${op2.toString(16)}`);
        }
      }
      case 253: {
        const op2 = r3.readUint();
        switch (op2) {
          case 0:
            return { op: "v128.load" /* v128_load */, memarg: readMemArg(r3) };
          case 1:
            return { op: "v128.load8x8_s" /* v128_load8x8_s */, memarg: readMemArg(r3) };
          case 2:
            return { op: "v128.load8x8_u" /* v128_load8x8_u */, memarg: readMemArg(r3) };
          case 3:
            return { op: "v128.load16x4_s" /* v128_load16x4_s */, memarg: readMemArg(r3) };
          case 4:
            return { op: "v128.load16x4_u" /* v128_load16x4_u */, memarg: readMemArg(r3) };
          case 5:
            return { op: "v128.load32x2_s" /* v128_load32x2_s */, memarg: readMemArg(r3) };
          case 6:
            return { op: "v128.load32x2_u" /* v128_load32x2_u */, memarg: readMemArg(r3) };
          case 7:
            return { op: "v128.load8_splat" /* v128_load8_splat */, memarg: readMemArg(r3) };
          case 8:
            return { op: "v128.load16_splat" /* v128_load16_splat */, memarg: readMemArg(r3) };
          case 9:
            return { op: "v128.load32_splat" /* v128_load32_splat */, memarg: readMemArg(r3) };
          case 10:
            return { op: "v128.load64_splat" /* v128_load64_splat */, memarg: readMemArg(r3) };
          case 11:
            return { op: "v128.store" /* v128_store */, memarg: readMemArg(r3) };
          case 12:
            return { op: "v128.const" /* v128_const */, bytes: r3.slice(16) };
          case 13: {
            const lanes = new Array(16);
            for (let i3 = 0; i3 < 16; i3++) {
              lanes[i3] = r3.readUint();
            }
            return { op: "i8x16.shuffle" /* i8x16_shuffle */, lanes };
          }
          case 15:
            return { op: "i8x16.splat" /* i8x16_splat */ };
          case 16:
            return { op: "i16x8.splat" /* i16x8_splat */ };
          case 17:
            return { op: "i32x4.splat" /* i32x4_splat */ };
          case 18:
            return { op: "i64x2.splat" /* i64x2_splat */ };
          case 19:
            return { op: "f32x4.splat" /* f32x4_splat */ };
          case 20:
            return { op: "f64x2.splat" /* f64x2_splat */ };
          case 21:
            return { op: "i8x16.extract_lane_s" /* i8x16_extract_lane_s */, lane: r3.read8() };
          case 22:
            return { op: "i8x16.extract_lane_u" /* i8x16_extract_lane_u */, lane: r3.read8() };
          case 23:
            return { op: "i8x16.replace_lane" /* i8x16_replace_lane */, lane: r3.read8() };
          case 24:
            return { op: "i16x8.extract_lane_s" /* i16x8_extract_lane_s */, lane: r3.read8() };
          case 25:
            return { op: "i16x8.extract_lane_u" /* i16x8_extract_lane_u */, lane: r3.read8() };
          case 26:
            return { op: "i16x8.replace_lane" /* i16x8_replace_lane */, lane: r3.read8() };
          case 27:
            return { op: "i32x4.extract_lane" /* i32x4_extract_lane */, lane: r3.read8() };
          case 28:
            return { op: "i32x4.replace_lane" /* i32x4_replace_lane */, lane: r3.read8() };
          case 29:
            return { op: "i64x2.extract_lane" /* i64x2_extract_lane */, lane: r3.read8() };
          case 30:
            return { op: "i64x2.replace_lane" /* i64x2_replace_lane */, lane: r3.read8() };
          case 31:
            return { op: "f32x4.extract_lane" /* f32x4_extract_lane */, lane: r3.read8() };
          case 32:
            return { op: "f32x4.replace_lane" /* f32x4_replace_lane */, lane: r3.read8() };
          case 33:
            return { op: "f64x2.extract_lane" /* f64x2_extract_lane */, lane: r3.read8() };
          case 34:
            return { op: "f64x2.replace_lane" /* f64x2_replace_lane */, lane: r3.read8() };
          case 35:
            return { op: "i8x16.eq" /* i8x16_eq */ };
          case 36:
            return { op: "i8x16.ne" /* i8x16_ne */ };
          case 37:
            return { op: "i8x16.lt_s" /* i8x16_lt_s */ };
          case 38:
            return { op: "i8x16.lt_u" /* i8x16_lt_u */ };
          case 39:
            return { op: "i8x16.gt_s" /* i8x16_gt_s */ };
          case 40:
            return { op: "i8x16.gt_u" /* i8x16_gt_u */ };
          case 41:
            return { op: "i8x16.le_s" /* i8x16_le_s */ };
          case 42:
            return { op: "i8x16.le_u" /* i8x16_le_u */ };
          case 43:
            return { op: "i8x16.ge_s" /* i8x16_ge_s */ };
          case 44:
            return { op: "i8x16.ge_u" /* i8x16_ge_u */ };
          case 45:
            return { op: "i16x8.eq" /* i16x8_eq */ };
          case 46:
            return { op: "i16x8.ne" /* i16x8_ne */ };
          case 47:
            return { op: "i16x8.lt_s" /* i16x8_lt_s */ };
          case 48:
            return { op: "i16x8.lt_u" /* i16x8_lt_u */ };
          case 49:
            return { op: "i16x8.gt_s" /* i16x8_gt_s */ };
          case 50:
            return { op: "i16x8.gt_u" /* i16x8_gt_u */ };
          case 51:
            return { op: "i16x8.le_s" /* i16x8_le_s */ };
          case 52:
            return { op: "i16x8.le_u" /* i16x8_le_u */ };
          case 53:
            return { op: "i16x8.ge_s" /* i16x8_ge_s */ };
          case 54:
            return { op: "i16x8.ge_u" /* i16x8_ge_u */ };
          case 55:
            return { op: "i32x4.eq" /* i32x4_eq */ };
          case 56:
            return { op: "i32x4.ne" /* i32x4_ne */ };
          case 57:
            return { op: "i32x4.lt_s" /* i32x4_lt_s */ };
          case 58:
            return { op: "i32x4.lt_u" /* i32x4_lt_u */ };
          case 59:
            return { op: "i32x4.gt_s" /* i32x4_gt_s */ };
          case 60:
            return { op: "i32x4.gt_u" /* i32x4_gt_u */ };
          case 61:
            return { op: "i32x4.le_s" /* i32x4_le_s */ };
          case 62:
            return { op: "i32x4.le_u" /* i32x4_le_u */ };
          case 63:
            return { op: "i32x4.ge_s" /* i32x4_ge_s */ };
          case 64:
            return { op: "i32x4.ge_u" /* i32x4_ge_u */ };
          case 65:
            return { op: "f32x4.eq" /* f32x4_eq */ };
          case 66:
            return { op: "f32x4.ne" /* f32x4_ne */ };
          case 67:
            return { op: "f32x4.lt" /* f32x4_lt */ };
          case 68:
            return { op: "f32x4.gt" /* f32x4_gt */ };
          case 69:
            return { op: "f32x4.le" /* f32x4_le */ };
          case 70:
            return { op: "f32x4.ge" /* f32x4_ge */ };
          case 71:
            return { op: "f64x2.eq" /* f64x2_eq */ };
          case 72:
            return { op: "f64x2.ne" /* f64x2_ne */ };
          case 73:
            return { op: "f64x2.lt" /* f64x2_lt */ };
          case 74:
            return { op: "f64x2.gt" /* f64x2_gt */ };
          case 75:
            return { op: "f64x2.le" /* f64x2_le */ };
          case 76:
            return { op: "f64x2.ge" /* f64x2_ge */ };
          case 77:
            return { op: "v128.not" /* v128_not */ };
          case 78:
            return { op: "v128.and" /* v128_and */ };
          case 79:
            return { op: "v128.andnot" /* v128_andnot */ };
          case 80:
            return { op: "v128.or" /* v128_or */ };
          case 81:
            return { op: "v128.xor" /* v128_xor */ };
          case 82:
            return { op: "v128.bitselect" /* v128_bitselect */ };
          case 83:
            return { op: "v128.any_true" /* v128_any_true */ };
          case 84:
            return { op: "v128.load8_lane" /* v128_load8_lane */, memarg: readMemArg(r3), lane: r3.read8() };
          case 85:
            return { op: "v128.load16_lane" /* v128_load16_lane */, memarg: readMemArg(r3), lane: r3.read8() };
          case 86:
            return { op: "v128.load32_lane" /* v128_load32_lane */, memarg: readMemArg(r3), lane: r3.read8() };
          case 87:
            return { op: "v128.load64_lane" /* v128_load64_lane */, memarg: readMemArg(r3), lane: r3.read8() };
          case 88:
            return { op: "v128.store8_lane" /* v128_store8_lane */, memarg: readMemArg(r3), lane: r3.read8() };
          case 89:
            return { op: "v128.store16_lane" /* v128_store16_lane */, memarg: readMemArg(r3), lane: r3.read8() };
          case 90:
            return { op: "v128.store32_lane" /* v128_store32_lane */, memarg: readMemArg(r3), lane: r3.read8() };
          case 91:
            return { op: "v128.store64_lane" /* v128_store64_lane */, memarg: readMemArg(r3), lane: r3.read8() };
          case 92:
            return { op: "v128.load32_zero" /* v128_load32_zero */, memarg: readMemArg(r3) };
          case 93:
            return { op: "v128.load64_zero" /* v128_load64_zero */, memarg: readMemArg(r3) };
          case 94:
            return { op: "f32x4.demote_zero_f64x2" /* f32x4_demote_zero_f64x2 */ };
          case 95:
            return { op: "f64x2.promote_low_f32x4" /* f64x2_promote_low_f32x4 */ };
          case 96:
            return { op: "i8x16.abs" /* i8x16_abs */ };
          case 97:
            return { op: "i8x16.neg" /* i8x16_neg */ };
          case 98:
            return { op: "i8x16.popcnt" /* i8x16_popcnt */ };
          case 99:
            return { op: "i8x16.all_true" /* i8x16_all_true */ };
          case 100:
            return { op: "i8x16.bitmask" /* i8x16_bitmask */ };
          case 101:
            return { op: "i8x16.narrow_i16x8_s" /* i8x16_narrow_i16x8_s */ };
          case 102:
            return { op: "i8x16.narrow_i16x8_u" /* i8x16_narrow_i16x8_u */ };
          case 107:
            return { op: "i8x16.shl" /* i8x16_shl */ };
          case 108:
            return { op: "i8x16.shr_s" /* i8x16_shr_s */ };
          case 109:
            return { op: "i8x16.shr_u" /* i8x16_shr_u */ };
          case 110:
            return { op: "i8x16.add" /* i8x16_add */ };
          case 111:
            return { op: "i8x16.add_sat_s" /* i8x16_add_sat_s */ };
          case 112:
            return { op: "i8x16.add_sat_u" /* i8x16_add_sat_u */ };
          case 113:
            return { op: "i8x16.sub" /* i8x16_sub */ };
          case 114:
            return { op: "i8x16.sub_sat_s" /* i8x16_sub_sat_s */ };
          case 115:
            return { op: "i8x16.sub_sat_u" /* i8x16_sub_sat_u */ };
          case 116:
            return { op: "f64x2.ceil" /* f64x2_ceil */ };
          case 117:
            return { op: "f64x2.floor" /* f64x2_floor */ };
          case 118:
            return { op: "i8x16.min_s" /* i8x16_min_s */ };
          case 119:
            return { op: "i8x16.min_u" /* i8x16_min_u */ };
          case 120:
            return { op: "i8x16.max_s" /* i8x16_max_s */ };
          case 121:
            return { op: "i8x16.max_u" /* i8x16_max_u */ };
          case 122:
            return { op: "f64x2.trunc" /* f64x2_trunc */ };
          case 123:
            return { op: "i8x16.avgr_u" /* i8x16_avgr_u */ };
          case 124:
            return { op: "i16x8.extadd_pairwise_s_i8x16" /* i16x8_extadd_pairwise_s_i8x16 */ };
          case 125:
            return { op: "i16x8.extadd_pairwise_u_i8x16" /* i16x8_extadd_pairwise_u_i8x16 */ };
          case 126:
            return { op: "i32x4.extadd_pairwise_s_i16x8" /* i32x4_extadd_pairwise_s_i16x8 */ };
          case 127:
            return { op: "i32x4.extadd_pairwise_u_i16x8" /* i32x4_extadd_pairwise_u_i16x8 */ };
          case 128:
            return { op: "i16x8.abs" /* i16x8_abs */ };
          case 129:
            return { op: "i16x8.neg" /* i16x8_neg */ };
          case 131:
            return { op: "i16x8.all_true" /* i16x8_all_true */ };
          case 132:
            return { op: "i16x8.bitmask" /* i16x8_bitmask */ };
          case 133:
            return { op: "i16x8.narrow_i32x4_s" /* i16x8_narrow_i32x4_s */ };
          case 134:
            return { op: "i16x8.narrow_i32x4_u" /* i16x8_narrow_i32x4_u */ };
          case 135:
            return { op: "i16x8.extend_low_s_i8x16" /* i16x8_extend_low_s_i8x16 */ };
          case 136:
            return { op: "i16x8.extend_high_s_i8x16" /* i16x8_extend_high_s_i8x16 */ };
          case 137:
            return { op: "i16x8.extend_low_u_i8x16" /* i16x8_extend_low_u_i8x16 */ };
          case 138:
            return { op: "i16x8.extend_high_u_i8x16" /* i16x8_extend_high_u_i8x16 */ };
          case 139:
            return { op: "i16x8.shl" /* i16x8_shl */ };
          case 140:
            return { op: "i16x8.shr_s" /* i16x8_shr_s */ };
          case 141:
            return { op: "i16x8.shr_u" /* i16x8_shr_u */ };
          case 130:
            return { op: "i16x8.q15mulr_sat_s" /* i16x8_q15mulr_sat_s */ };
          case 142:
            return { op: "i16x8.add" /* i16x8_add */ };
          case 143:
            return { op: "i16x8.add_sat_s" /* i16x8_add_sat_s */ };
          case 144:
            return { op: "i16x8.add_sat_u" /* i16x8_add_sat_u */ };
          case 145:
            return { op: "i16x8.sub" /* i16x8_sub */ };
          case 146:
            return { op: "i16x8.sub_sat_s" /* i16x8_sub_sat_s */ };
          case 147:
            return { op: "i16x8.sub_sat_u" /* i16x8_sub_sat_u */ };
          case 148:
            return { op: "f64x2.nearest" /* f64x2_nearest */ };
          case 149:
            return { op: "i16x8.mul" /* i16x8_mul */ };
          case 150:
            return { op: "i16x8.min_s" /* i16x8_min_s */ };
          case 151:
            return { op: "i16x8.min_u" /* i16x8_min_u */ };
          case 152:
            return { op: "i16x8.max_s" /* i16x8_max_s */ };
          case 153:
            return { op: "i16x8.max_u" /* i16x8_max_u */ };
          case 155:
            return { op: "i16x8.avgr_u" /* i16x8_avgr_u */ };
          case 156:
            return { op: "i16x8.extmul_low_s_i8x16" /* i16x8_extmul_low_s_i8x16 */ };
          case 157:
            return { op: "i16x8.extmul_high_s_i8x16" /* i16x8_extmul_high_s_i8x16 */ };
          case 158:
            return { op: "i16x8.extmul_low_u_i8x16" /* i16x8_extmul_low_u_i8x16 */ };
          case 159:
            return { op: "i16x8.extmul_high_u_i8x16" /* i16x8_extmul_high_u_i8x16 */ };
          case 160:
            return { op: "i32x4.abs" /* i32x4_abs */ };
          case 161:
            return { op: "i32x4.neg" /* i32x4_neg */ };
          case 163:
            return { op: "i32x4.all_true" /* i32x4_all_true */ };
          case 164:
            return { op: "i32x4.bitmask" /* i32x4_bitmask */ };
          case 167:
            return { op: "i32x4.extend_low_s_i16x8" /* i32x4_extend_low_s_i16x8 */ };
          case 168:
            return { op: "i32x4.extend_high_s_i16x8" /* i32x4_extend_high_s_i16x8 */ };
          case 169:
            return { op: "i32x4.extend_low_u_i16x8" /* i32x4_extend_low_u_i16x8 */ };
          case 170:
            return { op: "i32x4.extend_high_u_i16x8" /* i32x4_extend_high_u_i16x8 */ };
          case 171:
            return { op: "i32x4.shl" /* i32x4_shl */ };
          case 172:
            return { op: "i32x4.shr_s" /* i32x4_shr_s */ };
          case 173:
            return { op: "i32x4.shr_u" /* i32x4_shr_u */ };
          case 174:
            return { op: "i32x4.add" /* i32x4_add */ };
          case 177:
            return { op: "i32x4.sub" /* i32x4_sub */ };
          case 181:
            return { op: "i32x4.mul" /* i32x4_mul */ };
          case 182:
            return { op: "i32x4.min_s" /* i32x4_min_s */ };
          case 183:
            return { op: "i32x4.min_u" /* i32x4_min_u */ };
          case 184:
            return { op: "i32x4.max_s" /* i32x4_max_s */ };
          case 185:
            return { op: "i32x4.max_u" /* i32x4_max_u */ };
          case 186:
            return { op: "i32x4.dot_s_i16x8" /* i32x4_dot_s_i16x8 */ };
          case 188:
            return { op: "i32x4.extmul_low_s_i16x8" /* i32x4_extmul_low_s_i16x8 */ };
          case 189:
            return { op: "i32x4.extmul_high_s_i16x8" /* i32x4_extmul_high_s_i16x8 */ };
          case 190:
            return { op: "i32x4.extmul_low_u_i16x8" /* i32x4_extmul_low_u_i16x8 */ };
          case 191:
            return { op: "i32x4.extmul_high_u_i16x8" /* i32x4_extmul_high_u_i16x8 */ };
          case 192:
            return { op: "i64x2.abs" /* i64x2_abs */ };
          case 193:
            return { op: "i64x2.neg" /* i64x2_neg */ };
          case 195:
            return { op: "i64x2.all_true" /* i64x2_all_true */ };
          case 196:
            return { op: "i64x2.bitmask" /* i64x2_bitmask */ };
          case 199:
            return { op: "i64x2.extend_low_s_i32x4" /* i64x2_extend_low_s_i32x4 */ };
          case 200:
            return { op: "i64x2.extend_high_s_i32x4" /* i64x2_extend_high_s_i32x4 */ };
          case 201:
            return { op: "i64x2.extend_low_u_i32x4" /* i64x2_extend_low_u_i32x4 */ };
          case 202:
            return { op: "i64x2.extend_high_u_i32x4" /* i64x2_extend_high_u_i32x4 */ };
          case 203:
            return { op: "i64x2.shl" /* i64x2_shl */ };
          case 204:
            return { op: "i64x2.shr_s" /* i64x2_shr_s */ };
          case 205:
            return { op: "i64x2.shr_u" /* i64x2_shr_u */ };
          case 206:
            return { op: "i64x2.add" /* i64x2_add */ };
          case 209:
            return { op: "i64x2.sub" /* i64x2_sub */ };
          case 213:
            return { op: "i64x2.mul" /* i64x2_mul */ };
          case 214:
            return { op: "i64x2.eq" /* i64x2_eq */ };
          case 215:
            return { op: "i64x2.ne" /* i64x2_ne */ };
          case 216:
            return { op: "i64x2.lt_s" /* i64x2_lt_s */ };
          case 217:
            return { op: "i64x2.gt_s" /* i64x2_gt_s */ };
          case 218:
            return { op: "i64x2.le_s" /* i64x2_le_s */ };
          case 219:
            return { op: "i64x2.ge_s" /* i64x2_ge_s */ };
          case 220:
            return { op: "i64x2.extmul_low_s_i32x4" /* i64x2_extmul_low_s_i32x4 */ };
          case 221:
            return { op: "i64x2.extmul_high_s_i32x4" /* i64x2_extmul_high_s_i32x4 */ };
          case 222:
            return { op: "i64x2.extmul_low_u_i32x4" /* i64x2_extmul_low_u_i32x4 */ };
          case 223:
            return { op: "i64x2.extmul_high_u_i32x4" /* i64x2_extmul_high_u_i32x4 */ };
          case 236:
            return { op: "f64x2.abs" /* f64x2_abs */ };
          case 237:
            return { op: "f64x2.neg" /* f64x2_neg */ };
          case 239:
            return { op: "f64x2.sqrt" /* f64x2_sqrt */ };
          case 240:
            return { op: "f64x2.add" /* f64x2_add */ };
          case 241:
            return { op: "f64x2.sub" /* f64x2_sub */ };
          case 242:
            return { op: "f64x2.mul" /* f64x2_mul */ };
          case 243:
            return { op: "f64x2.div" /* f64x2_div */ };
          case 244:
            return { op: "f64x2.min" /* f64x2_min */ };
          case 245:
            return { op: "f64x2.max" /* f64x2_max */ };
          case 246:
            return { op: "f64x2.pmin" /* f64x2_pmin */ };
          case 247:
            return { op: "f64x2.pmax" /* f64x2_pmax */ };
          case 248:
            return { op: "i32x4.trunc_sat_s_f32x4" /* i32x4_trunc_sat_s_f32x4 */ };
          case 249:
            return { op: "i32x4.trunc_sat_u_f32x4" /* i32x4_trunc_sat_u_f32x4 */ };
          case 250:
            return { op: "f32x4.convert_s_i32x4" /* f32x4_convert_s_i32x4 */ };
          case 251:
            return { op: "f32x4.convert_u_i32x4" /* f32x4_convert_u_i32x4 */ };
          case 252:
            return { op: "i32x4.trunc_sat_s_zero_f64x2" /* i32x4_trunc_sat_s_zero_f64x2 */ };
          case 253:
            return { op: "i32x4.trunc_sat_u_zero_f64x2" /* i32x4_trunc_sat_u_zero_f64x2 */ };
          case 254:
            return { op: "f64x2.convert_low_s_i32x4" /* f64x2_convert_low_s_i32x4 */ };
          case 255:
            return { op: "f64x2.convert_low_u_i32x4" /* f64x2_convert_low_u_i32x4 */ };
          case 257:
            return { op: "i32x4.relaxed_trunc_s_f32x4" /* i32x4_relaxed_trunc_s_f32x4 */ };
          case 258:
            return { op: "i32x4.relaxed_trunc_u_f32x4" /* i32x4_relaxed_trunc_u_f32x4 */ };
          case 259:
            return { op: "i32x4.relaxed_trunc_s_zero_f64x2" /* i32x4_relaxed_trunc_s_zero_f64x2 */ };
          case 260:
            return { op: "i32x4.relaxed_trunc_u_zero_f64x2" /* i32x4_relaxed_trunc_u_zero_f64x2 */ };
          case 271:
            return { op: "f64x2.relaxed_min" /* f64x2_relaxed_min */ };
          case 272:
            return { op: "f64x2.relaxed_max" /* f64x2_relaxed_max */ };
          case 263:
            return { op: "f64x2.relaxed_madd" /* f64x2_relaxed_madd */ };
          case 264:
            return { op: "f64x2.relaxed_nmadd" /* f64x2_relaxed_nmadd */ };
          case 265:
            return { op: "i8x16.relaxed_laneselect" /* i8x16_relaxed_laneselect */ };
          case 266:
            return { op: "i16x8.relaxed_laneselect" /* i16x8_relaxed_laneselect */ };
          case 267:
            return { op: "i32x4.relaxed_laneselect" /* i32x4_relaxed_laneselect */ };
          case 268:
            return { op: "i64x2.relaxed_laneselect" /* i64x2_relaxed_laneselect */ };
          case 273:
            return { op: "i16x8.relaxed_q15mulr_s" /* i16x8_relaxed_q15mulr_s */ };
          case 274:
            return { op: "i16x8.relaxed_dot_s_i8x16" /* i16x8_relaxed_dot_s_i8x16 */ };
          case 275:
            return { op: "i32x4.relaxed_dot_add_s_i16x8" /* i32x4_relaxed_dot_add_s_i16x8 */ };
        }
        throw new Error(`unhandled op 0xfd ${op2}`);
      }
      default:
  ...
  function readLimits(r3) {
    ...
    let shared = (b2 & 2) !== 0;
    if (b2 >> 2 !== 0) {
      throw new Error(`invalid limits flag ${b2.toString(16)}`);
    }
    ...
    while (!r3.done()) {
      ...
      switch (b2) {
        ...
        case 9:
          ...
          break;
        default:
          console.warn(`ignoring unknown name subsection id ${b2.toString(16)}`);
          r3.skip(size);
          break;
      }
    }
  ...
  function FunctionRef(props) {
    return /* @__PURE__ */ u2(Link, { title: `function ${props.index}`, target: ["function", props.index], children: props.module.functionNames.get(props.index) ?? `function ${props.index}` });
  }
  function GlobalRef(props) {
    const sec = props.module.sections.find(
      (sec2) => sec2.kind === "global" /* global */
    );
    return /* @__PURE__ */ u2(Link, { title: `global ${props.index}`, target: ["section", sec.index], children: props.module.globalNames.get(props.index) ?? `global ${props.index}` });
  }
  function FunctionType(props) {
    return /* @__PURE__ */ u2("code", { children: funcTypeToString(props.type) });
  }
    ...
    for (const section of module.sections) {
      switch (section.kind) {
        ...
        case "memory" /* memory */:
          ...
          break;
        case "export" /* export */:
          module.exports = readExportSection(
            getSectionReader(wasmBytes, section)
          );
  ...
  function dispatch() {
    for (var i3 = 0, n2 = arguments.length, _3 = {}, t3; i3 < n2; ++i3) {
      if (!(t3 = arguments[i3] + "") || t3 in _3 || /[\s.]/.test(t3)) throw new Error("illegal type: " + t3);
      _3[t3] = [];
    }
  ...
  Dispatch.prototype = dispatch.prototype = {
    ...
    on: function(typename, callback) {
      ...
      if (arguments.length < 2) {
        while (++i3 < n2) if ((t3 = (typename = T4[i3]).type) && (t3 = get(_3[t3], typename.name))) return t3;
        return;
      }
      if (callback != null && typeof callback !== "function") throw new Error("invalid callback: " + callback);
      while (++i3 < n2) {
        if (t3 = (typename = T4[i3]).type) _3[t3] = set(_3[t3], typename.name, callback);
        else if (callback == null) for (t3 in _3) _3[t3] = set(_3[t3], typename.name, null);
      }
      return this;
    },
    copy: function() {
      var copy = {}, _3 = this._;
      for (var t3 in _3) copy[t3] = _3[t3].slice();
  ...
  function onAdd(typename, value, options) {
    return function() {
      ...
      if (on2) for (var j4 = 0, m3 = on2.length; j4 < m3; ++j4) {
  ...
  function on_default(typename, value, options) {
    ...
    if (arguments.length < 2) {
      ...
      if (on2) for (var j4 = 0, m3 = on2.length, o3; j4 < m3; ++j4) {
    ...
    for (i3 = 0; i3 < n2; ++i3) this.each(on2(typenames[i3], value, options));
    return this;
  }
  ...
  function rgba(r3, g4, b2, a3) {
    if (a3 <= 0) r3 = g4 = b2 = NaN;
    return new Rgb(r3, g4, b2, a3);
  }
  ...
  function rgb(r3, g4, b2, opacity) {
    return arguments.length === 1 ? rgbConvert(r3) : new Rgb(r3, g4, b2, opacity == null ? 1 : opacity);
  }
  function Rgb(r3, g4, b2, opacity) {
    this.r = +r3;
    this.g = +g4;
  ...
  function hslConvert(o3) {
    ...
    o3 = o3.rgb();
    var r3 = o3.r / 255, g4 = o3.g / 255, b2 = o3.b / 255, min3 = Math.min(r3, g4, b2), max3 = Math.max(r3, g4, b2), h3 = NaN, s3 = max3 - min3, l3 = (max3 + min3) / 2;
    if (s3) {
      if (r3 === max3) h3 = (g4 - b2) / s3 + (g4 < b2) * 6;
      else if (g4 === max3) h3 = (b2 - r3) / s3 + 2;
      else h3 = (r3 - g4) / s3 + 4;
  ...
  var rgb_default = (function rgbGamma(y3) {
    ...
    function rgb2(start2, end) {
      var r3 = color2((start2 = rgb(start2)).r, (end = rgb(end)).r), g4 = color2(start2.g, end.g), b2 = color2(start2.b, end.b), opacity = nogamma(start2.opacity, end.opacity);
      return function(t3) {
        start2.r = r3(t3);
        start2.g = g4(t3);
        start2.b = b2(t3);
  ...
  function rgbSpline(spline) {
    return function(colors) {
      var n2 = colors.length, r3 = new Array(n2), g4 = new Array(n2), b2 = new Array(n2), i3, color2;
      for (i3 = 0; i3 < n2; ++i3) {
  ...
  function string_default(a3, b2) {
    var bi = reA.lastIndex = reB.lastIndex = 0, am, bm, bs, i3 = -1, s3 = [], q4 = [];
    a3 = a3 + "", b2 = b2 + "";
    ...
    return s3.length < 2 ? q4[0] ? one(q4[0].x) : zero(b2) : (b2 = q4.length, function(t3) {
      for (var i4 = 0, o3; i4 < b2; ++i4) s3[(o3 = q4[i4]).i] = o3.x(t3);
      return s3.join("");
    });
  }
  ...
  function decompose_default(a3, b2, c3, d3, e3, f4) {
  ...
  function interpolateTransform(parse, pxComma, pxParen, degParen) {
    ...
    function translate(xa, ya, xb, yb, s3, q4) {
      if (xa !== xb || ya !== yb) {
    ...
    function rotate(a3, b2, s3, q4) {
      if (a3 !== b2) {
        if (a3 - b2 > 180) b2 += 360;
        else if (b2 - a3 > 180) a3 += 360;
        q4.push({ i: s3.push(pop(s3) + "rotate(", null, degParen) - 2, x: number_default(a3, b2) });
      } else if (b2) {
        s3.push(pop(s3) + "rotate(" + b2 + degParen);
      }
    }
    function skewX(a3, b2, s3, q4) {
      if (a3 !== b2) {
        q4.push({ i: s3.push(pop(s3) + "skewX(", null, degParen) - 2, x: number_default(a3, b2) });
      } else if (b2) {
        s3.push(pop(s3) + "skewX(" + b2 + degParen);
      }
    }
    function scale(xa, ya, xb, yb, s3, q4) {
      if (xa !== xb || ya !== yb) {
    ...
    return function(a3, b2) {
      ...
      translate(a3.translateX, a3.translateY, b2.translateX, b2.translateY, s3, q4);
      rotate(a3.rotate, b2.rotate, s3, q4);
      skewX(a3.skewX, b2.skewX, s3, q4);
      scale(a3.scaleX, a3.scaleY, b2.scaleX, b2.scaleY, s3, q4);
      a3 = b2 = null;
      return function(t3) {
        var i3 = -1, n2 = q4.length, o3;
        while (++i3 < n2) s3[(o3 = q4[i3]).i] = o3.x(t3);
        return s3.join("");
      };
    };
  }
  ...
  function formatGroup_default(grouping, thousands) {
    return function(value, width) {
      var i3 = value.length, t3 = [], j4 = 0, g4 = grouping[0], length = 0;
      while (i3 > 0 && g4 > 0) {
        if (length + g4 + 1 > width) g4 = Math.max(1, width - length);
        t3.push(value.substring(i3 -= g4, i3 + g4));
  ...
  function formatTrim_default(s3) {
    out: for (var n2 = s3.length, i3 = 1, i0 = -1, i1; i3 < n2; ++i3) {
      switch (s3[i3]) {
        case ".":
          i0 = i1 = i3;
          break;
  ...
  function locale_default(locale2) {
    ...
    function formatPrefix2(specifier, value) {
      var f4 = newFormat((specifier = formatSpecifier(specifier), specifier.type = "f", specifier)), e3 = Math.max(-8, Math.min(8, Math.floor(exponent_default(value) / 3))) * 3, k3 = Math.pow(10, -e3), prefix = prefixes[8 + e3 / 3];
      return function(value2) {
        return f4(k3 * value2) + prefix;
      };
    }
    return {
      format: newFormat,
  ...
  function colors_default(specifier) {
    ...
    while (i3 < n2) colors[i3] = "#" + specifier.slice(i3 * 6, ++i3 * 6);
    return colors;
  }
  ...
  function intersect(x0, y0, x1, y1, x22, y22, x3, y3) {
    ...
    if (t3 * t3 < epsilon2) return;
    t3 = (x32 * (y0 - y22) - y32 * (x0 - x22)) / t3;
    return [x0 + t3 * x10, y0 + t3 * y10];
  }
  function cornerTangents(x0, y0, x1, y1, r1, rc, cw) {
    var x01 = x0 - x1, y01 = y0 - y1, lo = (cw ? rc : -rc) / sqrt(x01 * x01 + y01 * y01), ox = lo * y01, oy = -lo * x01, x11 = x0 + ox, y11 = y0 + oy, x10 = x1 + ox, y10 = y1 + oy, x00 = (x11 + x10) / 2, y00 = (y11 + y10) / 2, dx = x10 - x11, dy = y10 - y11, d22 = dx * dx + dy * dy, r3 = r1 - rc, D3 = x11 * y10 - x10 * y11, d3 = (dy < 0 ? -1 : 1) * sqrt(max2(0, r3 * r3 * d22 - D3 * D3)), cx0 = (D3 * dy - dx * d3) / d22, cy0 = (-D3 * dx - dy * d3) / d22, cx1 = (D3 * dy + dx * d3) / d22, cy1 = (-D3 * dx + dy * d3) / d22, dx0 = cx0 - x00, dy0 = cy0 - y00, dx1 = cx1 - x00, dy1 = cy1 - y00;
  ...
  function pie_default() {
    ...
    function pie(data) {
      ...
      if (sortValues != null) index.sort(function(i4, j5) {
        return sortValues(arcs[i4], arcs[j5]);
      });
      else if (sort != null) index.sort(function(i4, j5) {
    ...
    "string" == typeof n2.type && (function(n3) {
      ...
      for (var i3 in t3) {
        ...
        if (!("value" === i3 && "defaultValue" in t3 && null == l3 || Q2 && "children" === i3 && "noscript" === e3 || "class" === i3 || "className" === i3)) {
          ...
          "defaultValue" === i3 && "value" in t3 && null == t3.value ? i3 = "value" : "download" === i3 && true === l3 ? l3 = "" : "translate" === f4 && "no" === l3 ? l3 = false : "o" === f4[0] && "n" === f4[1] ? "ondoubleclick" === f4 ? i3 = "ondblclick" : "onchange" !== f4 || "input" !== e3 && "textarea" !== e3 || X3(t3.type) ? "onfocus" === f4 ? i3 = "onfocusin" : "onblur" === f4 ? i3 = "onfocusout" : J2.test(i3) && (i3 = f4) : f4 = i3 = "oninput" : o3 && G2.test(i3) ? i3 = i3.replace(K2, "-$&").toLowerCase() : null === l3 && (l3 = void 0), "oninput" === f4 && u4[i3 = f4] && (i3 = "oninputCapture"), u4[i3] = l3;
        }
      }
  ...
  function parseCPP(name) {
    ...
    let fn2 = parts.find((part) => part.endsWith("()") && part !== "decltype()");
    if (fn2) {
      fn2 = fn2.slice(0, -2);
    } else {
      fn2 = parts[parts.length - 1];
    }
    return fn2.split("::");
  }
  ...
  var Treemap = class extends C {
    constructor() {
      super(...arguments);
      __publicField(this, "containerRef", M());
    }
    render() {
      const { onDone } = this.props;
      return /* @__PURE__ */ u2(S, { children: [
        /* @__PURE__ */ u2("button", { className: "code-treemap-done", onClick: onDone, children: "\u274C" }),
        /* @__PURE__ */ u2("div", { className: "code-treemap", ref: this.containerRef })
      ] });
    }
    componentDidMount() {
      ...
      webtreemap.render(container, root2, {
        caption(node) {
          ...
          const fn2 = node;
          if (fn2.originalName && fn2.originalName !== node.id) {
            caption += `
${node.originalName}`;
          }
          return caption;
  ...
  var FunctionNode = class _FunctionNode {
    constructor(id2, originalName, size = 0) {
      __publicField(this, "id", id2);
      __publicField(this, "originalName", originalName);
      __publicField(this, "size", size);
      __publicField(this, "children", []);
      __publicField(this, "childrenByName", /* @__PURE__ */ new Map());
    }
    addFunction(func, path2, originalName) {
      ...
      const head = h3;
      if (tail.length === 0) {
        const child2 = new _FunctionNode(head, originalName, func.len);
        this.children.push(child2);
        return;
      }
      let child = this.childrenByName.get(head);
      if (!child) {
        child = new _FunctionNode(head);
    ...
    sort() {
      this.children.sort((a3, b2) => descending(a3.size, b2.size));
  ...
  function InlineEdit(props) {
    ...
    if (editing) {
      return /* @__PURE__ */ u2("form", { className: "inline-edit", onSubmit: commit, children: /* @__PURE__ */ u2(
        "input",
        {
          ref: input,
          size: 1,
      ...
      return /* @__PURE__ */ u2("span", { onClick: () => setEditing(true), children: [
        props.children,
        " ",
        /* @__PURE__ */ u2("button", { className: "inline-edit", children: "\u270E" })
      ] });
    }
  }
  ...
  // table.tsx
  var Table = class extends C {
    constructor() {
      super(...arguments);
      __publicField(this, "state", { limit: 100 });
      __publicField(this, "rows", memo(function(sortBy, limit, rows) {
        rows = [...rows];
    ...
    render() {
      ...
      return /* @__PURE__ */ u2("table", { cellSpacing: "0", cellPadding: "0", children: [
        /* @__PURE__ */ u2("thead", { children: /* @__PURE__ */ u2("tr", { children: this.props.columns.map((col) => {
          ...
          rows.map((row) => {
            return /* @__PURE__ */ u2(
              "tr",
              {
                ...
                children: this.props.columns.map((col) => {
                  return /* @__PURE__ */ u2("td", { className: classNames(col.className, col.cellClass), children: col.data(row) });
                })
              }
            );
          }),
          rows.length < this.props.children.length && /* @__PURE__ */ u2("tr", { children: /* @__PURE__ */ u2("td", { colSpan: this.props.columns.length, children: /* @__PURE__ */ u2(
            "button",
            {
  ...
  var Instructions = class extends C {
    constructor() {
      super(...arguments);
      __publicField(this, "state", { expanded: false });
      /** Maps label number => ref count of label. */
      __publicField(this, "labelRefCounts", []);
      /** Stack of label numbers based on nesting. */
      __publicField(this, "labelStack", []);
      __publicField(this, "nextLabel", 0);
    ...
    render() {
      ...
      for (const line of this.renderInstrs(this.props.instrs)) {
        ...
        if (lines.length >= 50 && !this.state.expanded) {
          expand = /* @__PURE__ */ u2("div", { children: [
            "\n",
            /* @__PURE__ */ u2("button", { onClick: this.expand, children: "show all" })
          ] });
          break;
        }
      }
      return /* @__PURE__ */ u2(S, { children: [
        /* @__PURE__ */ u2("pre", { class: "code", children: lines }),
        expand
      ] });
    }
    addLabel() {
    ...
    labelTarget(label) {
      return /* @__PURE__ */ u2("div", { class: "label", children: [
        /* @__PURE__ */ u2(
          XRef,
          {
            id: `label${label}`,
    ...
    *renderInstr(instr, indent = 0) {
      switch (instr.op) {
        ...
        case "loop" /* loop */: {
          const label = this.addLabel();
          yield /* @__PURE__ */ u2("div", { style: `padding-left: ${indent * 2}ch`, children: "loop" });
          yield this.labelTarget(label);
        ...
        case "if" /* if */: {
          const label = this.addLabel();
          yield /* @__PURE__ */ u2("div", { style: `padding-left: ${indent * 2}ch`, children: "if" });
          yield* this.renderInstrs(instr.body, indent + 1);
          if (instr.else) {
            yield /* @__PURE__ */ u2("div", { style: `padding-left: ${indent * 2}ch`, children: "else" });
        ...
        case "call" /* call */:
          yield /* @__PURE__ */ u2("div", { style: `padding-left: ${indent * 2}ch`, children: [
            instr.op,
            " ",
            /* @__PURE__ */ u2(FunctionRef, { module: this.props.module, index: instr.func })
          ] });
          break;
        ...
        case "global.set" /* global_set */:
          yield /* @__PURE__ */ u2("div", { style: `padding-left: ${indent * 2}ch`, children: [
            instr.op,
            " ",
            /* @__PURE__ */ u2(GlobalRef, { module: this.props.module, index: instr.global })
          ] });
          break;
  ...
  function EditableLocal(props) {
    return /* @__PURE__ */ u2("span", { className: "flex-container", onMouseOver: props.onHover, children: /* @__PURE__ */ u2(InlineEdit, { onEdit: props.onEdit, children: props.name }) });
  }
  function FunctionView(props) {
    const funcBody = readFunction(
    ...
    const [localNames, setLocalNames] = d2(
      () => {
    ...
    const [highlight, setHighlight] = d2(
      void 0
    );
    return /* @__PURE__ */ u2(Screen, { title: `function ${props.func.index}`, children: [
      /* @__PURE__ */ u2("table", { children: [
        /* @__PURE__ */ u2("tr", { children: [
          /* @__PURE__ */ u2("th", { className: "right", children: "name" }),
          /* @__PURE__ */ u2("td", { className: "break-all", children: props.name })
        ] }),
        funcType.params.length > 0 && /* @__PURE__ */ u2("tr", { children: [
          /* @__PURE__ */ u2("th", { className: "right", children: "params" }),
          /* @__PURE__ */ u2("td", { children: funcType.params.map((type2, index) => {
            const id2 = `local${index}`;
            return /* @__PURE__ */ u2("div", { class: "flex-container", children: [
              type2,
              "\xA0",
              /* @__PURE__ */ u2(
                EditableLocal,
        ...
        funcType.result.length > 0 && /* @__PURE__ */ u2("tr", { children: [
          /* @__PURE__ */ u2("th", { className: "right", children: "result" }),
          /* @__PURE__ */ u2("td", { children: funcType.result.map((p3) => p3).join(", ") })
        ] }),
        funcBody.locals.length > 0 && /* @__PURE__ */ u2("tr", { children: [
          /* @__PURE__ */ u2("th", { className: "right", children: "locals" }),
          /* @__PURE__ */ u2("td", { children: funcBody.locals.map((type2, i3) => {
  ...
  function IncrementalInput(args) {
    ...
    return /* @__PURE__ */ u2("input", { ...incrementalArgs });
  }
  function CodeSection(props) {
    const totalSize = T2(
      () => sum(props.children.map((f4) => f4.len)),
      props.children
    );
    const [filter2, setFilter] = d2("");
    const funcs = filter2 ? props.children.filter((f4) => {
      const name = props.functionNames.get(f4.index);
      return name?.match(filter2);
    }) : props.children;
    const columns = [
      { name: "index", className: "right", sort: null, data: (f4) => f4.index },
      {
        name: "name",
        cellClass: "break-all",
        sort: (a3, b2) => ascending(
          props.functionNames.get(a3.index),
          props.functionNames.get(b2.index)
        ),
        data: (f4) => /* @__PURE__ */ u2("code", { children: props.functionNames.get(f4.index) })
      },
      {
        name: "size",
        className: "right",
        sort: (a3, b2) => descending(a3.len, b2.len),
        data: (f4) => format(",")(f4.len)
      },
      {
        name: "%",
        className: "right",
        data: (f4) => format(".1%")(f4.len / totalSize)
      }
    ];
    return /* @__PURE__ */ u2(Screen, { title: '"code" section', children: [
      /* @__PURE__ */ u2("p", { style: { display: "flex" }, children: [
        /* @__PURE__ */ u2("div", { children: [
          ...
          /* @__PURE__ */ u2(
            "button",
            {
              ...
              children: "View Treemap"
            }
          )
        ] }),
        /* @__PURE__ */ u2("div", { style: { flex: 1 } }),
        /* @__PURE__ */ u2(
          IncrementalInput,
          {
      ...
      /* @__PURE__ */ u2(Table, { columns, onClick: (func) => props.onClick(func.index), children: funcs })
    ] });
  }
  ...
  function DataSection(props) {
    const columns = [
      ...
      },
      {
        name: "size",
        className: "right",
        sort: (a3, b2) => b2.init.byteLength - a3.init.byteLength,
        data: (data) => data.init.byteLength
      },
      {
        name: "init",
        data: (data) => {
          if (data.memidx === void 0) return "passive";
          return /* @__PURE__ */ u2(Instructions, { module: props.module, instrs: data.offset });
        }
      }
    ];
    ...
    return /* @__PURE__ */ u2(Screen, { title: '"data" section', children: [
      /* @__PURE__ */ u2("p", { children: "Initialization-time data." }),
      /* @__PURE__ */ u2(Table, { columns, onClick: props.onClick, children: props.data })
    ] });
  }
  function hex2(byte, pad = 2) {
    return byte.toString(16).padStart(pad, "0");
  }
  var HexView = class extends C {
    render() {
      ...
      return /* @__PURE__ */ u2("pre", { class: "hex", children: rows });
    }
  };
  function DataHex(props) {
    const name = props.module.dataNames.get(props.data.index);
    return /* @__PURE__ */ u2(Screen, { title: `data[${props.data.index}]`, children: [
      /* @__PURE__ */ u2("table", { children: [
        name ? /* @__PURE__ */ u2("tr", { children: [
          /* @__PURE__ */ u2("th", { children: "name" }),
          /* @__PURE__ */ u2("td", { children: name })
        ] }) : null,
        /* @__PURE__ */ u2("tr", { children: [
          /* @__PURE__ */ u2("th", { className: "right", children: "size" }),
          /* @__PURE__ */ u2("td", { children: [
            format(",")(props.data.init.byteLength),
            " bytes"
          ] })
        ] }),
        /* @__PURE__ */ u2("tr", { children: [
          /* @__PURE__ */ u2("th", { className: "right", children: "init" }),
          /* @__PURE__ */ u2("td", { children: /* @__PURE__ */ u2(Instructions, { module: props.module, instrs: props.data.offset }) })
        ] })
      ] }),
      /* @__PURE__ */ u2(HexView, { data: props.data.init })
    ] });
  }
  ...
  function ElementSection(props) {
        ...
        data: (elem) => {
          if (elem.mode === "active" /* active */) {
            return /* @__PURE__ */ u2("div", { children: [
              ...
              /* @__PURE__ */ u2("br", {}),
              "offset:",
              /* @__PURE__ */ u2(Instructions, { module: props.module, instrs: elem.offset })
            ] });
          } else {
            return elem.mode;
          }
    ...
    return /* @__PURE__ */ u2(Screen, { title: '"element" section', children: [
      /* @__PURE__ */ u2("p", { children: "Initializers for tables." }),
      /* @__PURE__ */ u2(Table, { columns, children: props.module.elements })
    ] });
  }
  ...
  function FunctionSection(props) {
    const columns = [
      ...
      {
        name: "type",
        data: (row) => /* @__PURE__ */ u2("code", { children: funcTypeToString(props.module.types[row.typeidx]) })
      }
    ];
    return /* @__PURE__ */ u2(Screen, { title: '"function" section', children: [
      /* @__PURE__ */ u2("p", { children: "Associates functions with their types." }),
      /* @__PURE__ */ u2(Table, { columns, onClick: (row) => props.onClick(row.index), children: props.module.functions })
    ] });
  }

  // section-globals.tsx
  function GlobalSection(props) {
    const [edited, setEdited] = d2(0);
    return /* @__PURE__ */ u2(Screen, { title: '"globals" section', children: [
      /* @__PURE__ */ u2("p", { children: "Global variables, accessible to both the host environment and Wasm." }),
      /* @__PURE__ */ u2("table", { children: [
        /* @__PURE__ */ u2("thead", { children: /* @__PURE__ */ u2("tr", { children: [
          /* @__PURE__ */ u2("th", { className: "right", children: "index" }),
          /* @__PURE__ */ u2("th", { children: "name" }),
          /* @__PURE__ */ u2("th", { children: "type" }),
          /* @__PURE__ */ u2("th", { children: "init" })
        ] }) }),
        /* @__PURE__ */ u2("tbody", { children: props.module.globals.map((global) => {
          return /* @__PURE__ */ u2("tr", { children: [
            /* @__PURE__ */ u2("td", { className: "right", children: global.index }),
            /* @__PURE__ */ u2("td", { className: "break-all flex-container", children: /* @__PURE__ */ u2(
              InlineEdit,
              {
                onEdit: (name) => {
                ...
                children: props.module.globalNames.get(global.index) ?? ""
              }
            ) }),
            /* @__PURE__ */ u2("td", { children: [
            ...
            /* @__PURE__ */ u2("td", { children: /* @__PURE__ */ u2(Instructions, { module: props.module, instrs: global.init }) })
          ] });
        }) })
      ] })
    ] });
    ...
    switch (props.desc.kind) {
      case "typeidx" /* typeidx */:
        return /* @__PURE__ */ u2("div", { children: [
          ...
          props.index,
          ": ",
          /* @__PURE__ */ u2(FunctionType, { type: props.module.types[props.desc.index] })
        ] });
      case "funcidx" /* funcidx */:
        return /* @__PURE__ */ u2("div", { children: [
          ...
          props.desc.index,
          ": ",
          /* @__PURE__ */ u2(FunctionRef, { module: props.module, index: props.desc.index })
        ] });
      case "tableidx" /* tableidx */: {
        const sec = props.module.sections.findIndex(
          (sec2) => sec2.kind === "table" /* table */
        );
        return /* @__PURE__ */ u2("div", { children: /* @__PURE__ */ u2(Link, { target: ["section", sec], children: [
          "table ",
          props.desc.index
        ] }) });
      }
      ...
      default:
        return /* @__PURE__ */ u2("div", { children: descToString(props.desc) });
    }
  }
    ...
    const columns = [
      {
        name: "name",
        cellClass: "break-all",
        data: (imp) => /* @__PURE__ */ u2("code", { children: [
          imp.module,
          ".",
          imp.name
        ] })
      ...
      {
        name: "desc",
        data: (imp) => /* @__PURE__ */ u2(ImpExpDesc, { module: props.module, index: imp.index, desc: imp.desc })
      }
    ];
    return /* @__PURE__ */ u2(Screen, { title: '"import" section', children: [
      /* @__PURE__ */ u2("p", { children: "Functions etc. imported from the host environment." }),
      /* @__PURE__ */ u2(Table, { columns, children: props.module.imports })
    ] });
  }
    ...
    const columns = [
      {
        name: "name",
        cellClass: "break-all",
        data: (exp) => /* @__PURE__ */ u2("code", { children: exp.name })
      },
      {
        name: "desc",
        cellClass: "break-all",
        data: (exp) => /* @__PURE__ */ u2(ImpExpDesc, { module: props.module, desc: exp.desc })
      }
    ];
    return /* @__PURE__ */ u2(Screen, { title: '"export" section', children: [
      /* @__PURE__ */ u2("p", { children: "Functions etc. exported to the host environment." }),
      /* @__PURE__ */ u2(Table, { columns, children: props.module.exports })
    ] });
  }
  ...
  function MemorySection(props) {
    ...
    return /* @__PURE__ */ u2(Screen, { title: '"memory" section', children: [
      /* @__PURE__ */ u2("p", { children: "Definition of memory. Currently limited to one entry." }),
      /* @__PURE__ */ u2(Table, { columns, children: props.module.memories })
    ] });
  }
  ...
  function NamesSection(props) {
    ...
    return /* @__PURE__ */ u2(Screen, { title: '"name" section', children: [
      /* @__PURE__ */ u2("p", { children: "Names for objects found in the file, typically for debugging purposes." }),
      /* @__PURE__ */ u2("table", { children: [
        /* @__PURE__ */ u2("tr", { children: [
          /* @__PURE__ */ u2("th", { className: "right", children: "module name" }),
          /* @__PURE__ */ u2("td", { children: sec.moduleName ?? /* @__PURE__ */ u2("i", { children: "none" }) })
        ] }),
        /* @__PURE__ */ u2("tr", { children: [
          /* @__PURE__ */ u2("th", { className: "right", children: "local names" }),
          /* @__PURE__ */ u2("td", { children: sec.localNames?.size ?? /* @__PURE__ */ u2("i", { children: "none" }) })
        ] }),
        /* @__PURE__ */ u2("tr", { children: [
          /* @__PURE__ */ u2("th", { className: "right", children: "function names" }),
          /* @__PURE__ */ u2("td", { children: sec.functionNames?.size ?? /* @__PURE__ */ u2("i", { children: "none" }) })
        ] }),
        /* @__PURE__ */ u2("tr", { children: [
          /* @__PURE__ */ u2("th", { className: "right", children: "global names" }),
          /* @__PURE__ */ u2("td", { children: sec.globalNames?.size ?? /* @__PURE__ */ u2("i", { children: "none" }) })
        ] }),
        /* @__PURE__ */ u2("tr", { children: [
          /* @__PURE__ */ u2("th", { className: "right", children: "data names" }),
          /* @__PURE__ */ u2("td", { children: sec.dataNames?.size ?? /* @__PURE__ */ u2("i", { children: "none" }) })
        ] })
      ] })
    ] });
  }
  ...
  function ProducersSection(props) {
    return /* @__PURE__ */ u2(Screen, { title: '"producers" section', children: [
      /* @__PURE__ */ u2("p", { children: [
        /* @__PURE__ */ u2("a", { href: "https://github.com/WebAssembly/tool-conventions/blob/main/ProducersSection.md", children: "Tools used" }),
        " ",
        "to produce the module."
      ] }),
      /* @__PURE__ */ u2("table", { children: props.module.producers.map((field) => /* @__PURE__ */ u2("tr", { children: [
        /* @__PURE__ */ u2("td", { children: field.name }),
        /* @__PURE__ */ u2("td", { children: field.values.map(({ name, version }) => /* @__PURE__ */ u2("div", { children: [
          name,
          " ",
          version
        ] })) })
  ...
  function TableSection(props) {
    ...
    return /* @__PURE__ */ u2(Screen, { title: '"table" section', children: [
      /* @__PURE__ */ u2("p", { children: "Collections of opaque references. (Wasm 1.0 only allowed a single table.)" }),
      /* @__PURE__ */ u2(Table, { columns, children: props.module.tables })
    ] });
  }
  ...
  function TypeSection(props) {
    const columns = [
      { name: "index", className: "right", data: (row) => row.index },
      {
        name: "type",
        cellClass: "break-all",
        data: (type2) => /* @__PURE__ */ u2(FunctionType, { type: type2 })
      }
    ];
    return /* @__PURE__ */ u2(Screen, { title: '"type" section', children: [
      /* @__PURE__ */ u2("p", { children: "One entry per distinct function type used in the module." }),
      /* @__PURE__ */ u2(Table, { columns, children: props.module.types.map((t3, i3) => ({ ...t3, index: i3 })) })
    ] });
  }
      ...
      "svg",
      {
        ...
        children: /* @__PURE__ */ u2(
          "g",
          {
            ...
            strokeWidth: "2",
            ref: (g4) => {
              select_default2(g4).selectAll("path").data(arcs).join("path").attr("fill", (d3) => color2(d3.data)).attr("stroke", (d3) => d3.data === props.hovered ? "black" : "none").attr("d", arc).on("mouseover", (ev, d3) => props.onHover(d3.data)).on("mouseout", (ev, d3) => props.onHover(void 0)).on("click", (e3, d3) => props.onClick(d3.data));
            }
          }
        )
      }
  ...
  function SectionTable(props) {
    ...
    return /* @__PURE__ */ u2("table", { style: "flex:1", cellSpacing: "0", cellPadding: "0", children: [
      /* @__PURE__ */ u2("thead", { children: /* @__PURE__ */ u2("tr", { children: [
        /* @__PURE__ */ u2("th", { children: "section" }),
        /* @__PURE__ */ u2("th", { className: "right", children: "size" }),
        /* @__PURE__ */ u2("th", { className: "right", children: "%" })
      ] }) }),
      /* @__PURE__ */ u2("tbody", { id: "table", children: props.sections.map((sec) => /* @__PURE__ */ u2(
        "tr",
        {
          ...
          children: [
            /* @__PURE__ */ u2("td", { children: sec.name ?? sec.kind }),
            /* @__PURE__ */ u2("td", { className: "right", children: format(",")(sec.len) }),
            /* @__PURE__ */ u2("td", { className: "right", children: format(".1%")(sec.len / totalSize) })
          ]
        }
      )) })
    ] });
  }
  var Sections = class extends C {
    constructor() {
      super(...arguments);
      __publicField(this, "onSectionHover", (section) => {
        this.setState({ hovered: section });
      });
    }
    render(props, state) {
      return /* @__PURE__ */ u2(Screen, { title: "sections", children: /* @__PURE__ */ u2("div", { style: "display: flex; align-items: center; gap: 2ex", children: [
        /* @__PURE__ */ u2(Pie, { ...props, ...state, onHover: this.onSectionHover }),
        /* @__PURE__ */ u2(SectionTable, { ...props, ...state, onHover: this.onSectionHover })
      ] }) });
    }
  };
  ...
  function Link(props) {
    return /* @__PURE__ */ u2("a", { title: props.title, href: urlFromLink(props.target), children: props.children });
  }
  function Screen(props) {
    return /* @__PURE__ */ u2(S, { children: [
      /* @__PURE__ */ u2("header", { children: /* @__PURE__ */ u2("h1", { children: [
        /* @__PURE__ */ u2("a", { href: "#", children: "weave" }),
        " > ",
        props.title
      ] }) }),
      /* @__PURE__ */ u2("main", { children: props.children })
    ] });
  }
  var Weave = class extends C {
    constructor() {
      super(...arguments);
      ...
      __publicField(this, "onHashChange", () => {
        ...
        if (target === "section") {
          ...
          const importedCount = this.props.module.imports.filter(
            (imp) => imp.desc.kind === "typeidx" /* typeidx */
          ).length;
          if (index < importedCount) {
            const section = this.props.module.sections.find(
              (sec) => sec.kind === "import" /* import */
            );
            if (section) {
      ...
      __publicField(this, "onSectionClick", (section) => {
        go(["section", section.index]);
      });
      __publicField(this, "onFuncClick", (index) => {
        go(["function", index]);
      });
      __publicField(this, "onDataClick", (data) => {
        go(["data", data.index]);
      });
    }
    componentDidMount() {
    ...
    render() {
      ...
      if (this.state.section) {
        switch (this.state.section.kind) {
          case "type" /* type */:
            return /* @__PURE__ */ u2(TypeSection, { module });
          case "import" /* import */:
            return /* @__PURE__ */ u2(Imports, { module });
          case "function" /* function */:
            return /* @__PURE__ */ u2(FunctionSection, { module, onClick: this.onFuncClick });
          case "table" /* table */:
            return /* @__PURE__ */ u2(TableSection, { module });
          case "global" /* global */:
            return /* @__PURE__ */ u2(GlobalSection, { module });
          case "memory" /* memory */:
            return /* @__PURE__ */ u2(MemorySection, { module });
          case "export" /* export */:
            return /* @__PURE__ */ u2(Exports, { module });
          case "element" /* element */:
            return /* @__PURE__ */ u2(ElementSection, { module });
          case "code" /* code */:
            return /* @__PURE__ */ u2(
              CodeSection,
              {
          ...
          case "custom" /* custom */:
            if (this.state.section.name === "name") {
              return /* @__PURE__ */ u2(NamesSection, { module });
            } else if (this.state.section.name === "producers") {
              return /* @__PURE__ */ u2(ProducersSection, { module });
            } else {
              return /* @__PURE__ */ u2(Screen, { title: "custom section", children: [
                /* @__PURE__ */ u2("p", { children: [
                  "No view yet for ",
                  /* @__PURE__ */ u2("code", { children: this.state.section.name }),
                  ". Showing raw dump."
                ] }),
                /* @__PURE__ */ u2(
                  HexView,
          ...
          default:
            return /* @__PURE__ */ u2("div", { children: [
              "TODO: no viewer implemented for '",
              this.state.section.kind,
              "' section yet"
            ] });
        }
  ...
  var App = class extends C {
    ...
    render() {
      if (this.state.module) {
        return /* @__PURE__ */ u2(Weave, { module: this.state.module });
      }
      return /* @__PURE__ */ u2(S, { children: [
        /* @__PURE__ */ u2("header", { children: /* @__PURE__ */ u2("h1", { children: "weave" }) }),
        /* @__PURE__ */ u2("main", { children: [
          /* @__PURE__ */ u2("p", { children: [
            "Weave is a viewer for WebAssembly ",
            /* @__PURE__ */ u2("code", { children: ".wasm" }),
            " files, like an interactive ",
            /* @__PURE__ */ u2("code", { children: "objdump" }),
            "."
          ] }),
          /* @__PURE__ */ u2("p", { children: [
            "Load a file by drag'n'drop'ing a ",
            /* @__PURE__ */ u2("code", { children: ".wasm" }),
            " file onto this page."
          ] })
        ] })
